	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> tablist = new ArrayList<>();
	      ...
	      try{
				...
				String url = "jdbc:mysql://localhost/cpa_test";
	            Connection con = DriverManager.getConnection(url,"root","arjun@23");
				 Statement stmt = con.createStatement();
				 System.out.println("hello before sql");
				 
				 String query = "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_SCHEMA='cpa_test'";
